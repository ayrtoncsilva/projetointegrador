...
const calcularDias = (cargaHoraria, horasDias) => {return cargaHoraria/horasDias}

function calcularDays(cargaHoraria, horasPorDia) {
...
console.log(`Data de término da turma (sem cancelamento): ${dataTermino.toDateString()}`)
...
console.log(`Nova data de término da turma (com cancelamento): ${dataTermino.toDateString()}`)